<!-- Source: https://doc.rust-lang.org/stable/cargo/commands/cargo-build.html -->
...
cargo-build â Compile the current package
...
`--package` *spec*â¦
:   Build only the specified packages. See [cargo-pkgid(1)](cargo-pkgid.html) for the
