...
to build reliable and efficient software. A [number](https://www.zdnet.com/article/microsoft-70-percent-of-all-security-bugs-are-memory-safety-issues/) of
[studies](https://www.chromium.org/Home/chromium-security/memory-safety) have found that roughly ~70% of high severity security bugs
...
* Speeding up CPU-bound computations by running them in parallel on several
  ...
  [rayon](https://docs.rs/rayon/). That said, it is still possible to "mix & match"
