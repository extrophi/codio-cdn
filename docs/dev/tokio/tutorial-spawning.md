...
This is done by binding [`tokio::net::TcpListener`](https://docs.rs/tokio/1/tokio/net/struct.TcpListener.html) to port **6379**.
...
chapter](shared-state#holding-a-mutexguard-across-an-await).
...
You can find the full code [here](https://github.com/tokio-rs/website/blob/master/tutorial-code/spawning/src/main.rs).

In the next section, we will implement persisting data for all sockets.

[![](/img/arrow-left.svg)Hello Tokio](/tokio/tutorial/hello-tokio)

[Shared state![](/img/arrow-right.svg)](/tokio/tutorial/shared-state)

Get Help:

[Edit this page](https://github.com/tokio-rs/website/edit/master/content/tokio/tutorial/spawning.md)